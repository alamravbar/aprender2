...
class Twitter{
  function getTweets(){
    ...
    $getfield = '?screen_name=e_aprender&count=20';
    $requestMethod = 'GET';
...
<body>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class='col-sm-4 col-md-6 pre-scrollable'>
        <div class="panel panel-primary">
          <div class="panel-heading"><h5>Twitter Aprender</h5></div>
      ...
      <div class="col-md-6">
          <a data-pin-do="embedUser" data-pin-board-width="800" data-pin-scale-height="600" data-pin-scale-width="800" href="https://www.pinterest.com/usarioprueba/"></a>
      </div>
