...
foreach($datosCombo as $elem){
 ...
 <label class='form-check-label'> <input class='form-check-input' type='checkbox' name='etiqueta[]' value=".$elem['id_etiqueta'].">".$elem['nombre']."</label></div>";
}
$comboetiqueta.="";
...
<form enctype="multipart/form-data" class="formulario .form-control">
 <div class="form-group">
    ...
    <input type="file" class="form-control-file" id="imagen" name="archivo">
  </div>

  <div class="form-group">
    <label for="comentario">Descripcion</label>
    <textarea class="form-control formulario" id="comentario" name="comentario" rows="3" cols="30">Ingrese descripcion del archivo....</textarea>
  </div>
